...
router.post('/', function(req, res) {
    ...
    newpromotion.listCakeIn = req.body.listCakeIn;
    newpromotion.isShow = req.body.isShow;
    newpromotion.StatusUpdateCakeSale = "NotUse"
...
router.put('/:id', function(req, res) {
        promotion.findByIdAndUpdate(req.params.id, {
                $set: {
                    ...
                    listCakeIn: req.body.listCakeIn,
                    isShow: req.body.isShow,
                    StatusUpdateCakeSale: req.body.StatusUpdateCakeSale,
