...
//                 if (Person1[key1].cake == Person2[key2].cake) {
//                     existp1p2[Person1[key1].cake] = 1
//                     break;
//                 }
//             }
//         }
    ...
    for (var other in datafilter) {
        ...
        for (var data1 in dataPerson1) {
            if (!(await isExist2(dataPerson2, dataPerson1[data1]))) {
                totals.setDefault(dataPerson1[data1].cake, dataPerson1[data1].rate * similar);
                simsum.setDefault(dataPerson1[data1].cake, similar);
            }
        }
    }
